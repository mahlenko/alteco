                    ...
                    <div class="settings__acc">
                        ...
                        <ul class="settings__list">
                            ...
                            <li class="d-flex">
                                ...
                                <a href="javascript:void(0);" class="settings__text"
                                   onclick="return alert('Функция в разработке, попробуйте позже.')">
                                    Тарифы
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)" class="scan__show btn btn1 settings__btn"
                                   onclick="return alert('Функция в разработке, попробуйте позже.')">
                                    Улучшить тариф
                                </a>
                            </li>
                        ...
                        <div class="settings__el">
                            <div class="setting-form__item">
                                ...
                                <input type="text" name="name"
                                       ...
                                       placeholder="John Johnson" class="name">
                            </div>

                            <div class="setting-form__item">
                                <label>Email</label> <br>
                                <input type="email" name="email" inputmode="email"
                                       value="{{ old('name', isset($user) ? $user->email : null) }}" required
                            ...
                            <div class="settings__el">
                                <div class="setting-form__item">
                                    ...
                                    <select name="role" id="role">
                                        <option value="{{ \Blackshot\CoinMarketSdk\Models\User::ROLE_USER }}"
                                                @if ((isset($user) && old('role', $user->role) === \Blackshot\CoinMarketSdk\Models\User::ROLE_USER) || old('role') === \Blackshot\CoinMarketSdk\Models\User::ROLE_USER) selected @endif>
                                            User
                                        </option>
                                        <option value="{{ \Blackshot\CoinMarketSdk\Models\User::ROLE_ADMIN }}"
                                                @if ((isset($user) && old('role', $user->role) === \Blackshot\CoinMarketSdk\Models\User::ROLE_ADMIN) || old('role') === \Blackshot\CoinMarketSdk\Models\User::ROLE_ADMIN) selected @endif>
                                            Administrator
                                        </option>
                                    </select>
                                </div>
